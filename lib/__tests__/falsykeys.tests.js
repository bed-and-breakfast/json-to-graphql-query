...
describe('jsonToGraphQLQuery() - falsy keys', function () {
    ...
    it('Includes the nested object if includeFalsyKeys is true', function () {
        var query = {
            query: {
                Posts: {
                    id: true,
        ...
        (0, chai_1.expect)((0, __1.jsonToGraphQLQuery)(query, { includeFalsyKeys: true })).to.equal('query { Posts { id name } Lorem { Ipsum { name } } }');
    });
    it('does not include the object if nested object has falsy values', function () {
        var query = {
            query: {
                Posts: {
                    id: true,
        ...
        (0, chai_1.expect)((0, __1.jsonToGraphQLQuery)(query)).to.equal('query { Posts { id } }');
    });
    it('skip objects when deeply nested keys contain falsy values', function () {
        var query = {
            query: {
                id: true,
                Posts: {
        ...
        (0, chai_1.expect)((0, __1.jsonToGraphQLQuery)(query)).to.equal('query { id Posts { id } Lorem { details { address } } }');
    });
    it('Include values if nested object has falsy values and includeFalsyKeys is true', function () {
        var query = {
            query: {
                Posts: {
                    id: true,
